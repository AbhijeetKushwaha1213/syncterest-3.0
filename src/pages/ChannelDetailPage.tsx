...
const ChannelDetailPage = () => {
  ...
  return (
    <LoadingBoundary
      isLoading={isLoadingChannel || isLoadingRole}
      error={channelError}
      loadingComponent={<ChannelDetailSkeleton />}
      errorComponent={
        <div className="flex items-center justify-center h-full">
          <div className="text-center">
            <AlertTriangle className="mx-auto h-12 w-12 text-destructive mb-4" />
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="flex flex-col flex-1">
            ...
            <div className="flex-1 overflow-hidden">
              <TabsContent value="chat" className="h-full m-0 p-0">
                <SectionErrorBoundary sectionName="Channel Chat">
                  <ChannelChat channel={channel} />
                </SectionErrorBoundary>
              </TabsContent>
              <TabsContent value="voice" className="h-full m-0 p-0">
                <SectionErrorBoundary sectionName="Channel Voice">
